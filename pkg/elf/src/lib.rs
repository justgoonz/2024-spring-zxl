...
pub fn map_physical_memory(
    offset: u64,
    max_addr: u64,
    page_table: &mut impl Mapper<Size2MiB>, //页表映射trait
    frame_allocator: &mut impl FrameAllocator<Size4KiB>,//物理帧分配trait
) {
    trace!("Mapping physical memory...");//trace！宏，只在调试状态在输出
    //创建物理地址
    ...
    for frame in PhysFrame::range_inclusive(start_frame, end_frame) {
        ...
        unsafe {
            page_table//对Mapper的引用
                .map_to(page, frame, flags, frame_allocator)//page是虚拟页，frame是物理内存，一一对应的关系
